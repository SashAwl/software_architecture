...
public class UsersApi {
     ...
     */
    public com.squareup.okhttp.Call createClientCall(User body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createClientValidateBeforeCall(User body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public User createClient(User body) throws ApiException {
        ApiResponse<User> resp = createClientWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<User> createClientWithHttpInfo(User body) throws ApiException {
    ...
    /**
     * Метод создания пользователя (asynchronously)
     * 
     * @param body  (required)
     ...
     */
    public com.squareup.okhttp.Call createClientAsync(User body, final ApiCallback<User> callback) throws ApiException {
     ...
     * @param userId Имя пользователя (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteUserByIdCall(String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteUserByIdValidateBeforeCall(String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    /**
     * Метод удаления пользователя по его id (asynchronously)
     * 
     * @param userId Имя пользователя (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteUserByIdAsync(String userId, final ApiCallback<Void> callback) throws ApiException {
    ...
    /**
     * Метод получения информации о пользователе по его id (asynchronously)
     * 
     * @param userId Имя пользователя (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
