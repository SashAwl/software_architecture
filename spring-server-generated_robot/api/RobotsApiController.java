...
@RestController
public class RobotsApiController implements RobotsApi {

    private static final Logger log = LoggerFactory.getLogger(RobotsApiController.class);
    ...
    public RobotsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Robot> addRobot(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody Robot body) {
    ...
    public ResponseEntity<Robot> getAllRobots() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Robot>(objectMapper.readValue("{\n  \"ID_robot\" : 382292,\n  \"Version\" : 0,\n  \"Capacity_battery\" : 1900,\n  \"Model\" : \"Garlyn\",\n  \"IP-adress\" : 6,\n  \"User_id\" : 382292,\n  \"Name_machine\" : \"Benedikt\"\n}", Robot.class), HttpStatus.NOT_IMPLEMENTED);
